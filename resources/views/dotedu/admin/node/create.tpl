                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="method">
                                                ...
                                                <option value="chacha20" selected="selected">
                                                    chacha20
                                                </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="protocol">
                                                ...
                                                <option value="verify_simple">
                                                    verify_simple
                                                </option>
                                                <option value="verify_deflate">
                                                    verify_deflate
                                                </option>
                                                <option value="verify_sha1">
                                                    verify_sha1
                                                </option>
                                                <option value="auth_simple">
                                                    auth_simple
                                                </option>
                                                <option value="auth_sha1" selected="selected">
                                                    auth_sha1
                                                </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="obfs">
                                                ...
                                                <option value="tls_simple">
                                                    tls_simple
                                                </option>
                                                <option value="random_head">
                                                    random_head
                                                </option>
                                                <option value="tls1.0_session_auth" selected="selected">
                                                    tls1.0_session_auth
                                                </option>
                                            </select>
                                        </div>
